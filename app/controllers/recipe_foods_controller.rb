class RecipeFoodsController < ApplicationController
  ...
  def index
    @recipe_foods = RecipeFood.includes(:recipe_item, :food)
  end
  ...
  def set_recipe_food
    @recipe_food = RecipeFood.includes(:recipe_item, :food).find(params[:id])
  end

  # Only allow a list of trusted parameters through.
  def recipe_food_params
    params.require(:recipe_food).permit(:recipe_item_id, :food_id, :quantity)
  end
end
